...
FROM ubuntu:22.04@sha256:0bced47fffa3361afa981854fcabcd4577cd43cebbb808cea2b1f33a3dd7f508 as dev
...
ARG ACTIONLINT_VERSION=v1.6.25
RUN \
...
ARG NODE_BUILD_VERSION=v4.9.117
